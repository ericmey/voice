...
DEFAULT_SERVICE_REGEX = (
    "openclaw-livekit-nyla|openclaw-livekit-aoi|openclaw-livekit-party|openclaw-.*"
)
FAILURE_REGEX = (
...
def _main() -> int:
    ...
    agent_selector = (
        '{service_name=~"openclaw-livekit-nyla|openclaw-livekit-aoi|openclaw-livekit-party"}'
    )
    queries = [
        LokiQuery(
