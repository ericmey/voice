...
render_plist() {
  ...
  sed \
    ...
    -e "s|{{OPENCLAW_OTEL_ENABLED}}|${OPENCLAW_OTEL_ENABLED:-${LANGSMITH_TRACING:-false}}|g" \
    -e "s|{{OPENCLAW_OTEL_EXPORTERS}}|${OPENCLAW_OTEL_EXPORTERS:-langsmith}|g" \
    -e "s|{{OPENCLAW_OTEL_DEBUG}}|${OPENCLAW_OTEL_DEBUG:-${LANGSMITH_PROCESSOR_DEBUG:-false}}|g" \
    -e "s|{{OPENCLAW_OTEL_HTTP_INSTRUMENTATION}}|${OPENCLAW_OTEL_HTTP_INSTRUMENTATION:-true}|g" \
    -e "s|{{OPENCLAW_DEPLOYMENT_ENVIRONMENT}}|${OPENCLAW_DEPLOYMENT_ENVIRONMENT:-production}|g" \
    ...
    -e "s|{{OPENCLAW_PHOENIX_ENDPOINT}}|${OPENCLAW_PHOENIX_ENDPOINT:-}|g" \
    -e "s|{{OPENCLAW_PHOENIX_HEADERS}}|${OPENCLAW_PHOENIX_HEADERS:-}|g" \
    -e "s|{{OPENCLAW_OTLP_ENDPOINT}}|${OPENCLAW_OTLP_ENDPOINT:-}|g" \
    -e "s|{{OPENCLAW_OTLP_HEADERS}}|${OPENCLAW_OTLP_HEADERS:-}|g" \
    -e "s|{{OPENCLAW_OTEL_LOGS_ENABLED}}|${OPENCLAW_OTEL_LOGS_ENABLED:-}|g" \
